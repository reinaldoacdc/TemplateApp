...
begin
  ...
  try
    ...
    raise Exception.Create('Erro ao Excluir Usu�rio: ' + ex.Message);
  end;
end;
...
begin
  ...
  try
    ...
    raise Exception.Create('Erro ao inserir Usu�rio: ' + ex.Message);
  end;
end;
...
begin
  ...
  try
    ...
    raise Exception.Create('Erro ao alterar Usu�rio: ' + ex.Message);
  end;
end;
